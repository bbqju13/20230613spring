...
번호 : <input type="text" name="bno" value="${board.bno }" readonly="readonly">  <br> <br>
...
등록일 : <input type="text" name="reg_date" value="${board.reg_date }" readonly="readonly"> <br> <br>
내용 : <br>
<textarea rows="10" cols="30" name="content">${board.content }</textarea> <br> <br>
